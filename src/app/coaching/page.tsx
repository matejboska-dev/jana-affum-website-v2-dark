...
export const metadata: Metadata = {
  ...
  description:
    'Discreet coaching for leaders at a crossroads and expat professionals in Prague and across Europe. English-speaking coach with 10+ years in international recruitment.',
  openGraph: {
    title: 'Private Coaching & Thinking Partnership | Jana Affum',
    description:
      'A confidential thinking partnership for leaders navigating career transitions, cross-border moves, or important life decisions. English-speaking coach in Prague.',
  ...
  twitter: {
    ...
    title: 'Private Coaching & Thinking Partnership | Jana Affum',
    description:
      'Discreet coaching and career transition strategy for leaders and expats.',
